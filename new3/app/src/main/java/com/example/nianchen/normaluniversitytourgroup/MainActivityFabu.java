...
//        up_load(pathImage);
        ...
        try {
           strid= EMClient.getInstance().groupManager().createGroup(groupName, desc,new String[]{} ,reason, option).getGroupId();
...
//        }
    ...
    public void  fwqjohn(){
        if(paths==null)
            Toast.makeText(MainActivityFabu.this, "请给群组添加头像", Toast.LENGTH_LONG).show();
        else {
            Log.e("tv3", "onclick");
            Log.e("dsss", paths);
            ...
            client.get(url, rp, new AsyncHttpResponseHandler() {
                ...
                public void onSuccess(int i, Header[] headers, byte[] bytes) {
                    ...
                    result = "ok";
                    Intent o = new Intent();
                    o.setClass(MainActivityFabu.this, GroupActivity.class);
                    startActivity(o);
